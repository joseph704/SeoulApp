...
public class MainActivity extends Activity {
    ...
    Button btnOn, btnOff,btnLed1,btnLed2,btnLed3,btnLed4;
    TextView txtArduino;
    Handler h;
    ...
    private static String address = "00:18:E5:04:23:78";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btnLed1.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mConnectedThread.write(toString().valueOf("1"));
        ...
        btnLed2.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mConnectedThread.write(toString().valueOf("2"));
        ...
        btnLed3.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mConnectedThread.write(toString().valueOf("3"));
        ...
        btnLed4.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mConnectedThread.write(toString().valueOf("4"));
